...
public class TimeseriesTest extends AbstractYahooApiTest
{
    ...
    public void test()
    {
        ...
        List<Timeseries.Quote> quotes = yahoo.timeseriesOperations().getTimeseries("GOOD", from, to);
    ...
    {
        List<Timeseries.Quote> quotes = yahoo.timeseriesOperations().getTimeseries(symbol, from, to);
