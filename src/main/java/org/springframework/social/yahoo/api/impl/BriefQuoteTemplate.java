...
public class BriefQuoteTemplate extends AbstractTemplate implements BriefQuoteOperations
{
    ...
    public BriefQuoteTemplate(RestOperations restOperations, ObjectMapper objectMapper, boolean isAuthorized)
    {
    ...
    public List<BriefQuote.Quote> getQuotes(Collection<String> symbols)
    {
        ...
        BriefQuote.Wrapper wrapper = getRestOperations().getForObject(buildUri(params), BriefQuote.Wrapper.class);
